...
export class PaymentComponent {
  ...
  private initConfig(): void {
    this.payPalConfig = {
      ...
      onClick: (data: any, actions: { reject: () => any; }) => {
        console.log('onClick');
  ...
  options = {
    ...
    "prefill": {
      "name": "anunya",
      "email": "anunyachowdary125@gmail.com",
      "contact": "9346100767"
    },
    "notes": {
      "address": ""
  ...
  paynow() {
    ...
    this.options.prefill.name = "Anunya";
    this.options.prefill.email = "anunyachowdary125@gmail.com";
    this.options.prefill.contact = "9346100767";
